...
from src.training.train_concept_ablation import train_concept_ablation
...
def main() -> None:
    ...
    report = Path("experiments/concept_ablation_report.md")
    payload = train_concept_ablation(config, bundle, report)
